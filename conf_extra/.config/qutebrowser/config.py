...
config.bind(",i", "hint links spawn --userscript transmission home /downloads/complete/music {hint-url}")
config.bind(",o", "hint links spawn --userscript transmission home /downloads/complete/tv {hint-url}")
config.bind(",p", "hint links spawn --userscript transmission home /downloads/complete/film {hint-url}")
